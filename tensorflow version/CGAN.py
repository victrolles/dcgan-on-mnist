...
def build_generator(inputs, labels, image_size):
    ...
    x = concatenate([inputs, labels], axis=1) #différence avec DCGAN!!!
    ...
    generator = Model([inputs, labels], x, name='generator') #différence avec DCGAN!!!
    return generator
...
def build_discriminator(inputs, labels, image_size):
    ...
    x = Activation('sigmoid')(x)
    # input is conditioned by labels
    discriminator = Model([inputs, labels], x, name='discriminator') #différence avec DCGAN!!!
